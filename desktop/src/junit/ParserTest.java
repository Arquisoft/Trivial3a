...
public class ParserTest {
	...
	public void testGIFT() {
		...
		rFalsas1.add("El sosten"); rFalsas1.add("De en medio"); rFalsas1.add("El vestido azul y negro, o es blanco y dorado?");
		...
		Pregunta p2 = new Pregunta("Q2", "¿Cuando fue 1+1", rFalsas2, "El fantastico Ralph!");
		try {
